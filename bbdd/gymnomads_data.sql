...
('Urban Fitness Center', 'Rúa da Raíña, 2, 27001 Lugo', 'Lugo', 43.0107, -7.5570),
('CostaFit A Coruña', 'Av. de Hércules, 30, 15002 A Coruña', 'A Coruña', 43.3765, -8.4093);
...
-- Insertar usuarios de prueba (con roles y contraseñas hasheadas) /  Insert test users (with roles and hashed passwords)
--
-- 
