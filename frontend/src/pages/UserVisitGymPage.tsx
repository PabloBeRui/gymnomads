    ...
    <Container fluid="sm" className="py-3 py-md-4">
      <Row className="justify-content-center">
        <Col md={10} lg={8} className={styles.relativeCol}>
          ...
          <Alert
            className={clsx("text-center mb-2", styles.customSuccessAlert)}>
            <h4>✓ ¡Visita Confirmada!</h4>{" "}
            <p>Tu acceso al gimnasio está listo.</p>
          </Alert>

          {/* 2. Código QR (Reordenado: Segundo - Central) */}
          {/* 2. QR Code (Reordered: Second - Central) */}
          <Card
            className="text-center mb-4 border-0 shadow-lg"
          ...
          <Alert variant="warning" className="mb-4 border-0 shadow-sm">
            <div className="d-flex align-items-center mb-2">
              ...
              <Alert.Heading
                as="h4"
                className={clsx("h6 mb-0", "text-primary")}>
                Instrucciones de Acceso
              </Alert.Heading>
            </div>
            <ul className="mb-0 ps-3">
              <li className="text-dark mb-1">
                Presenta este código QR en la recepción del gimnasio.
              </li>
              <li className="text-dark mb-1">
                El código es de un solo uso y válido para hoy.
              </li>
            </ul>
          </Alert>
          ...
          <Card className="mb-4 border-0 shadow-sm bg-light">
            <Card.Header
              ...
              <div className="d-flex align-items-center">
                ...
                <h3 className={clsx("h6 mb-0", "text-primary")}>
                  Detalles del Ticket
                </h3>
              </div>
              <i
