...
import { createGym } from "../services";

// Importar utilidades / Import utilities
import { handleApiError } from "../utils";

// Tipos / Types
import type { CreateGymManagerResponse } from "../interfaces";
...
export const AddGymPage = () => {
  ...
  const handleChange = (
    ...
    // Actualizado para incluir HTMLTextAreaElement
  ...
  return (
    <div className={styles.pageWrapper} onClick={() => navigate(-1)}>
      <Container
        ...
        />
        <h2 className="text-primary pt-3 mb-4 text-center">
        ...
        <Alert variant="warning" className="mb-4">
          ...
          email del manager será generado automáticamente a partir del nombre
          del gimnasio (ejemplo:{" "}
          <span className="text-primary">nombregimnasio@gymnomads.com</span>).
        </Alert>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3" controlId="gymHours">
            <Form.Label className="text-secondary fw-bold">
              Horario:{" "}
              <span className="text-secondary fw-normal">(opcional)</span>
            </Form.Label>
            <Form.Control
              name="gymHours"
              as="textarea"
            ...
            />
            <Form.Text className={clsx(styles.helperText, "text-dark")}>
              Introduce el horario de apertura del gimnasio. Los saltos de línea
              se respetarán.
            </Form.Text>
          </Form.Group>
        ...
        <Alert variant="info" className="mt-4">
          ...
          principal) podrán ser añadidas por el manager desde la página de
          edición una vez creado el gimnasio.
        </Alert>
      </Container>
    </div>
  );
